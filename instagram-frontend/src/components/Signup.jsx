...
const Signup = () => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            console.error("Asli Error ye hai:", error.response ? error.response.data : error.message);
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#fafafa', fontFamily: 'sans-serif' }}>
            <div style={{ background: 'white', padding: '40px', border: '1px solid #dbdbdb', width: '350px', textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '12px', color: '#8e8e8e', marginTop: '10px' }}>
                    By signing up, you agree to our Terms, Data Policy and Cookies Policy.
                </p>
                
                <div style={{ borderTop: '1px solid #dbdbdb', marginTop: '20px', paddingTop: '20px' }}>
                    <p style={{ fontSize: '14px' }}>
                        Have an account? <span onClick={() => navigate('/login')} style={{ color: '#0095f6', fontWeight: 'bold', cursor: 'pointer' }}>Log in</span>
                    </p>
                </div>
            </div>
        </div>
