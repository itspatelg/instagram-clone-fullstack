...
const EditProfile = () => {
    ...
    useEffect(() => {
        const fetchCurrentData = async () => {
            const res = await axios.get(`https://instagram-clone-fullstack-production.up.railway.app/api/users/profile?username=${username}&currentUserEmail=${userEmail}`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            await axios.post('https://instagram-clone-fullstack-production.up.railway.app/api/users/update', {
                email: userEmail,
                fullName,
                bio,
                profilePictureUrl
